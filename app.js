...
// production purposes use process.env.PORT setup in Heroku
// development purposes use 3000
const port = process.env.PORT || 3000;

// listen for connections on port 3000 locally can go to localhost:3000
app.listen(port, () => {    
